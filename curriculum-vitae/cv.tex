...
\cvitem{Virudhunagar}{Tamil Nadu, India}
...
%\textsc{Project: } )}
% \cventry{\textsc{2008--2010}}{Intermediate (AISSCE)}{SCHOOL}{CITY}{\emph{India}}{$85\%$ Central Board of Secondary Education (CBSE)}

\spacesection
\section{Experience}
\subsection{Internships}

\cventry{\textsc{Summer 2022}}{Prof. Arnar Pálsson}{University of Iceland}{}{Research Staff}{Detailed analysis in a literate and reproducible manner for simulating a series of possible molecular evolutionary pathways for the \textit{Salmolid} using phylogenetic trees. \\~\\
 \textsc{Project Report: }Computational Primitives for Evolutionary Paths
}
...
\cventry{\textsc{2021--present}}{Biological Society}{IISER Mohali}{}{Member}{Enthusiastic participant and also arrange for independent peer-reviewed article readings.}
...
\cvdoubleitem{\textsc{Experienced}}{Phylogenetic Tree Construction (Distance, Maximum Likelihood, Bayesian), Evolutionary Biology, Population genetics, R reproducible literate programming, High performance open source software, Scientific Software Development for High Throughput calculations}
           {\textsc{Interested}}{Biomolecular simulations, Genomics, Modeling genetic markers for disease}
