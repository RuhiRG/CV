...
:END:
#+begin_export latex
\cventry{\textsc{2024--2026}}{M.S. Biological Science}{University of Iceland}{Reyjavik}{\emph{Iceland}}{(\textsc{Advisor: } Prof. Arnar Pálsson)}{(\textsc{Project: Diversity in craniofacial elements by populations and sexes in salmonids} )}
